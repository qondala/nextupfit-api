...
export class AppService {
  getHello(): string {
    ...
    <center style="margin-top: 10%;">
      <h1> FitCoaching Platform 🏋️‍♀️ - Backend </h1> 
      ...
      <h3>Utilisation </h3>
      <ul>
        <li>Utilisez <a href="http://localhost:3000/api">l'API RESTful</a> pour interagir avec les différentes fonctionnalités de la plateforme.</li>
