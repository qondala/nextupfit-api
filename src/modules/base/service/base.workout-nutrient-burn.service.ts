...
export class BaseWorkoutNutrientBurnService {
  ...
  async create(
    createBaseWorkoutNutrientBurnDto: CreateBaseWorkoutNutrientBurnDto,
  ): Promise<BaseWorkoutNutrientBurnEntity> {
    const newNutrientBurn = this.baseWorkoutNutrientBurnRepository.create(
      createBaseWorkoutNutrientBurnDto,
    );
  ...
  async findAll(
    ...
    const queryBuilder =
      this.baseWorkoutNutrientBurnRepository.createQueryBuilder("nutrientBurn");
  ...
  async update(
    ...
    const result = await this.baseWorkoutNutrientBurnRepository.update(
      id,
      updateBaseWorkoutNutrientBurnDto,
    );
