...
export class BaseWorkoutNutrientBurnController {
  constructor(
    private readonly baseWorkoutNutrientBurnService: BaseWorkoutNutrientBurnService,
  ) {}
  ...
  async create(
    @Body() createBaseWorkoutNutrientBurnDto: CreateBaseWorkoutNutrientBurnDto,
  ): Promise<DetailsBaseWorkoutNutrientBurnDto> {
    return (await this.baseWorkoutNutrientBurnService.create(
      createBaseWorkoutNutrientBurnDto,
    )) as unknown as DetailsBaseWorkoutNutrientBurnDto;
  }
  ...
  async findOne(
    ...
    const nutrientBurn = (await this.baseWorkoutNutrientBurnService.findOne(
      id,
    )) as unknown as DetailsBaseWorkoutNutrientBurnDto;
    if (!nutrientBurn) {
      throw new NotFoundException(
        `Workout nutrient burn with ID ${id} not found`,
      );
    }
    return nutrientBurn;
  }
  ...
  async update(
    ...
    const nutrientBurn = (await this.baseWorkoutNutrientBurnService.update(
      id,
      updateBaseWorkoutNutrientBurnDto,
    )) as unknown as DetailsBaseWorkoutNutrientBurnDto;
    if (!nutrientBurn) {
