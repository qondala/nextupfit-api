...
} from "./browser.previous.from.step-activity-workingsession-workout.service";
    ...
    async browse(current: ProgramNavigationNode): Promise<ProgramNavigationNode> {
      ...
      while (previousStepActivityWorkingsession) {
        ...
        let lastWorkingsessionOfPreviousActivity = 
          await this.programStepActivityWorkingsessionService
            .findLast(previousStepActivityWorkingsession.id);
        
        let previousNavigationItem = 
          await this.browserPreviousFromStepActivityWorkingsessionWorkoutService
            .browse({
        ...
        let everStartedOrCompletedWorkingsession = 
        ...
        previousStepActivityWorkingsession = 
          await this.programStepActivityWorkingsessionService
            .findPrevious(previousStepActivityWorkingsession.id);
      };
