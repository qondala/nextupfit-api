...
export class NavigatorProgramStepActivityWorkingsessionWorkoutController {
  ...
  @Get('next')
  @ApiOperation({
    operationId: 'getProgramStepActivityWorkingsessionWorkoutNextNavigationNode',
    summary: 'Get program step activity workingsession workout next navigation node'
  })
  @ApiQuery({
    required: true,
