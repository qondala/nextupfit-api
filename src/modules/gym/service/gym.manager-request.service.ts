...
export class GymManagerRequestService {
  ...
  async create(
    createDto: CreateGymManagerRequestDto,
  ): Promise<GymManagerRequestEntity> {
  ...
  async findByGym(
    ...
    const queryBuilder = this.gymManagerRequestRepository
  ...
  async update(
    id: number,
    updateDto: UpdateGymManagerRequestDto,
  ): Promise<GymManagerRequestEntity> {
    await this.gymManagerRequestRepository.update({ id }, updateDto);
