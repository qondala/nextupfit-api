...
export class GymManagerSpecializedInWorkoutService {
  ...
  async create(
    createDto: CreateGymManagerSpecializedInWorkoutDto,
  ): Promise<GymManagerSpecializedInWorkoutEntity> {
  ...
  async findByManager(
    ...
    const queryBuilder = this.repository
      .createQueryBuilder("specializedWorkout")
  ...
  async update(
    id: number,
    updateDto: UpdateGymManagerSpecializedInWorkoutDto,
  ): Promise<GymManagerSpecializedInWorkoutEntity> {
