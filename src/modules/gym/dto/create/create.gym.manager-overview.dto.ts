...
export class CreateGymManagerOverviewDto {
  ...
  @ApiProperty({
    ...
    example:
      "https://res.cloudinary.com/ds9ufzny1/image/upload/v1697110655/gyms/covers/the-training-ground.png",
    required: false,
  })
  @IsOptional()
  @IsString()
  ...
  @ApiProperty({
    type: SwaggerType.STRING,
    description: "Manager photo URL",
    example:
      "https://res.cloudinary.com/ds9ufzny1/image/upload/v1697110655/gyms/photos/the-training-ground.png",
    required: false,
  })
  @IsOptional()
  @IsString()
