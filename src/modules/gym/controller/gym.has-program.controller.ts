...
export class GymHasProgramController {
  ...
  create(
    @Body() createGymHasProgramDto: CreateGymHasProgramDto,
  ...
  findByManagerId(
    ...
    return this.gymHasProgramService.findByManagerId(
      managerId,
      paginationOptions,
    );
  }
  ...
  @ApiOperation({
    summary:
      "Get gym has program records by gym ID and manager ID with pagination",
  ...
  findByGymIdAndManagerId(
    ...
    return this.gymHasProgramService.findByGymIdAndManagerId(
      gymId,
      managerId,
      paginationOptions,
    );
  ...
  @ApiOperation({
    summary:
      "Get gym has program records by item type and manager ID with pagination",
  ...
  findByItemTypeAndManagerId(
    @Param("itemType", new ParseEnumPipe(ProgramItemTypeEnum))
    itemType: ProgramItemTypeEnum,
    @Param("managerId", ParseIntPipe) managerId: number,
    @Query() paginationOptions: PaginationOptionsDto,
  ): Promise<PaginatedDetailsGymHasProgramDto> {
    return this.gymHasProgramService.findByItemTypeAndManagerId(
      itemType,
      managerId,
      paginationOptions,
    );
