...
export class GymMembershipController {
  ...
  async getAllMembershipsOfGym(
    ...
    return await this.gymMembershipService.getAllMembershipsOfGym(gymId, pagination);
  }
  ...
  async getAllUserGymMemberships(
    ...
    return await this.gymMembershipService.getAllUserGymMemberships(userId, pagination);
  }
  ...
  async getAllUserAndGymMemberships(
    ...
    return await this.gymMembershipService.getAllUserAndGymMemberships(userId, gymId, pagination);
  }
  ...
  async getUserGymMembershipWithPlanId(
    ...
    return await this.gymMembershipService.getUserGymMembershipWithPlanId(userId, gymId, gymMembershipPlanId);
  }
  ...
  async getMembershipById(@Param('id', ParseIntPipe) id: number): Promise<DetailsGymMembershipDto> {
  ...
  async updateMembershipStatus(
    ...
    @Param('gymId', ParseIntPipe) gymId: number,
    @Param('gymMembershipPlanId', ParseIntPipe) gymMembershipPlanId: number,
    @Param('status', new ParseEnumPipe(GymMembershipStatusEnum)) status: GymMembershipStatusEnum,
  ): Promise<void> {
    await this.gymMembershipService.updateGymMembershipStatusByPlanId(userId, gymId, gymMembershipPlanId, status);
    return;
  }
