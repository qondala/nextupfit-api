...
export class GymManagerSpecializedInWorkoutController {
  constructor(
    private readonly gymManagerSpecializedInWorkoutService: GymManagerSpecializedInWorkoutService,
  ) {}
  ...
  async create(@Body() createDto: CreateGymManagerSpecializedInWorkoutDto) {
  ...
  async findByManager(
    ...
    return await this.gymManagerSpecializedInWorkoutService.findByManager(
      managerId,
      paginationOptions,
    );
  }
  ...
  async update(
    ...
    return await this.gymManagerSpecializedInWorkoutService.update(
      id,
      updateDto,
    );
  }
  ...
  async findManagersSpecializedInWorkouts(
    ...
    @Query("workoutIds", new ParseArrayPipe({ items: Number }))
    workoutIds: number[],
  ): Promise<PaginatedDetailsGymManagerSpecializedInWorkoutDto> {
    return this.gymManagerSpecializedInWorkoutService.findManagersSpecializedInWorkouts(
      workoutIds,
      options,
    );
  }
