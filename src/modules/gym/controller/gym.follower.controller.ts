...
export class GymFollowerController {
  ...
  async findAllFollowersOfGym(
    ...
    return this.gymFollowerService.findAllFollowersOfGym(gymId, paginationOptions);
  }
  ...
  async findAllGymsFollowedByUser(
    ...
    return this.gymFollowerService.findAllGymsFollowedByUser(userId, paginationOptions);
  }
