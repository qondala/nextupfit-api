...
export class GymHasManagerController {
  constructor(private readonly gymHasManagerService: GymHasManagerService) {}
  ...
  ): Promise<PaginatedDetailsGymHasManagerDto> {
    return await this.gymHasManagerService.findAllGymManagers(
      gymId,
      paginationOptions,
    );
  }
  ...
  async findAllManagerGyms(
    ...
    return await this.gymHasManagerService.findAllManagerGyms(
      managerId,
      paginationOptions,
    );
  }
  ...
  async updateStatusByManagerIdAndGymId(
    ...
    await this.gymHasManagerService.updateStatusByManagerIdAndGymId(
      managerId,
      gymId,
      updateDto.status,
    );
  ...
  async updateRoleByManagerIdAndGymId(
    ...
    await this.gymHasManagerService.updateRoleByManagerIdAndGymId(
      managerId,
      gymId,
      updateDto.role,
    );
