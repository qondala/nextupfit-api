...
export class GymController {
  ...
  @ApiOperation({
    ...
    summary: 'Get best rated and attended gyms specialized in specific workouts'
  })
  @ApiQuery({
  ...
  @ApiOkResponse({
    description: 'List of best rated and attended gyms specialized in workouts.',
    type: PaginatedDetailsGymDto
  })
  ...
  @ApiOperation({
    ...
    summary: 'Get best rated and attended gyms specialized in specific nutritions'
  })
  @ApiQuery({
  ...
  @ApiOkResponse({
    description: 'List of best rated and attended gyms specialized in nutritions.',
    type: PaginatedDetailsGymDto
  })
  ...
  @ApiOperation({
    operationId: 'findBestRatedAndAttentedGymsSpecializedInNutritionsAndWorkouts',
    summary: 'Get best rated and attended gyms specialized in both nutritions AND workouts'
  })
  @ApiQuery({
    name: 'specializedNutritions',
    required: true,
  ...
  @ApiOkResponse({
    description: 'List of best rated and attended gyms specialized in both nutritions and workouts.',
    type: PaginatedDetailsGymDto
  })
  ...
  @ApiOperation({
    operationId: 'findBestRatedAndAttentedGymsSpecializedInNutritionsOrWorkouts',
    summary: 'Get best rated and attended gyms specialized in nutritions OR workouts'
  })
  @ApiQuery({
    name: 'specializedNutritions',
    required: true,
  ...
  @ApiOkResponse({
    description: 'List of best rated and attended gyms specialized in nutritions or workouts.',
    type: PaginatedDetailsGymDto
  })
  ...
  @ApiOperation({
    operationId: 'findBestRatedAndAttentedGymsSpecializedInNutritionsAndWorkoutsAndSpeciality',
    summary: 'Get best rated and attended gyms specialized in nutritions AND workouts AND speciality'
  })
  @ApiQuery({
    name: 'specializedNutritions',
    required: true,
  ...
  @ApiOkResponse({
    description: 'List of best rated and attended gyms specialized in nutritions, workouts and speciality.',
    type: PaginatedDetailsGymDto
  })
  ...
  @ApiOperation({
    operationId: 'findBestRatedAndAttentedGymsSpecializedInNutritionsOrWorkoutsOrSpeciality',
    summary: 'Get best rated and attended gyms specialized in nutritions OR workouts OR speciality'
  })
  @ApiQuery({
    name: 'specializedNutritions',
    required: true,
  ...
  @ApiOkResponse({
    description: 'List of best rated and attended gyms specialized in nutritions, workouts or speciality.',
    type: PaginatedDetailsGymDto
  })
  ...
  async findRandomGymsInSpeciality(
    @Query('speciality', new ParseEnumPipe(GymSpecialityEnum)) speciality: GymSpecialityEnum,
    @Query() paginationOptions: PaginationOptionsDto
  ): Promise<PaginatedDetailsGymDto> {
    return this.gymService.findRandomGymsInSpeciality(speciality, paginationOptions);
  }
  ...
  async findRandomGymsInSpecialities(
    @Query('specialities', new ParseEnumArrayPipe(GymSpecialityEnum)) specialities: GymSpecialityEnum[],
    @Query() paginationOptions: PaginationOptionsDto
  ): Promise<PaginatedDetailsGymDto> {
