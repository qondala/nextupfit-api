...
export class GymSpecializedInNutritionController {
  ...
  async findByGym(
    ...
    return this.service.findByGym(+gymId, { page: +page, limit: +limit });
  }
  ...
  async findOne(@Param("id") id: string): Promise<DetailsGymSpecializedInNutritionDto> {
  ...
  async update(@Param("id") id: string, @Body() dto: UpdateGymSpecializedInNutritionDto): Promise<DetailsGymSpecializedInNutritionDto> {
