...
export class ContentFaqItemController {
  ...
  async create(@Body() dto: CreateContentFaqItemDto): Promise<DetailsContentFaqItemDto> {
  ...
  async findOne(@Param("id", ParseIntPipe) id: number): Promise<DetailsContentFaqItemDto> {
