...
export class ContentTipsItemController {
  ...
  async create(
    @Body() dto: CreateContentTipsItemDto,
  ): Promise<DetailsContentTipsItemDto> {
    return await this.service.create(dto);
  }

  @Get("list/:contentTipsId")
  @ApiOperation({
  ...
  async findAll(
    @Param("contentTipsId", ParseIntPipe) contentTipsId: number,
    @Query() query: PaginationOptionsDto,
  ): Promise<PaginatedDetailsContentTipsItemDto> {
    return this.service.findAll(contentTipsId, query);
  }
  ...
  ): Promise<DetailsContentTipsItemDto | null> {
