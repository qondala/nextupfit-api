...
export class ContentRecipeController {
  ...
  async create(@Body() dto: CreateContentRecipeDto): Promise<DetailsContentRecipeDto> {
  ...
  async findOne(@Param("id", ParseIntPipe) id: number): Promise<DetailsContentRecipeDto> {
