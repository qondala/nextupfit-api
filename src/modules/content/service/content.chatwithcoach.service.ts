...
export class ContentChatWithCoachService {
  constructor(
    @InjectRepository(ContentChatWithCoachEntity)
  ...
  async findAll(options: PaginationOptionsDto): Promise<PaginatedResponseDto<ContentChatWithCoachEntity>> {
  ...
  async findOne(id: number): Promise<ContentChatWithCoachEntity> {
    ...
    if (!entity) throw new Error(`Content chat with coach ${id} not found`);
    return entity;
  }
