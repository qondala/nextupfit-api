...
export class ContentAccordionService {
  constructor(
    @InjectRepository(ContentAccordionEntity)
  ...
  async findAll(options: PaginationOptionsDto): Promise<PaginatedResponseDto<ContentAccordionEntity>> {
  ...
  async findOne(id: number): Promise<ContentAccordionEntity> {
    ...
    if (!entity) throw new Error(`Content accordion ${id} not found`);
    return entity;
  }
