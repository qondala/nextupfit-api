...
export class ContentGoalsService {
  ...
  async findAll(contentId: number, options: PaginationOptionsDto): Promise<PaginatedResponseDto<ContentGoalsEntity>> {
  ...
  async findOneWithContentId(contentId: number): Promise<ContentGoalsEntity> {
