...
export class ContentCommitmentService {
  ...
  async findAll(contentId: number, options: PaginationOptionsDto): Promise<PaginatedResponseDto<ContentCommitmentEntity>> {
  ...
  async findOneWithContentId(contentId: number): Promise<ContentCommitmentEntity> {
