...
export class ContentOrderedlistService {
  ...
  async findAll(contentId: number, options: PaginationOptionsDto): Promise<PaginatedResponseDto<ContentOrderedlistEntity>> {
  ...
  async findOneWithContentId(contentId: number): Promise<ContentOrderedlistEntity | null> {
