...
export class ContentOrderedlistService {
  ...
  async create(
    dto: CreateContentOrderedlistDto,
  ): Promise<ContentOrderedlistEntity> {
  ...
  ): Promise<PaginatedResponseDto<ContentOrderedlistEntity>> {
  ...
  async findOneWithContentId(
    contentId: number,
  ): Promise<ContentOrderedlistEntity | null> {
  ...
  async update(
    id: number,
    dto: UpdateContentOrderedlistDto,
  ): Promise<ContentOrderedlistEntity> {
