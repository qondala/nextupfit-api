...
export class ContentUsersupportService {
  ...
  async findAll(contentId: number, options: PaginationOptionsDto): Promise<PaginatedResponseDto<ContentUsersupportEntity>> {
  ...
  async findOneWithContentId(contentId: number): Promise<ContentUsersupportEntity | null> {
