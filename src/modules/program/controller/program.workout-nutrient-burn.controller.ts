...
export class ProgramWorkoutNutrientBurnController {
  constructor(
    private readonly programWorkoutNutrientBurnService: ProgramWorkoutNutrientBurnService,
  ) {}
  ...
  @ApiResponse({
    ...
    description:
      "The program workout nutrient burn has been successfully created.",
    type: DetailsProgramWorkoutNutrientBurnDto,
  })
  create(
    @Body()
    createProgramWorkoutNutrientBurnDto: CreateProgramWorkoutNutrientBurnDto,
  ): Promise<DetailsProgramWorkoutNutrientBurnDto> {
    return this.programWorkoutNutrientBurnService.create(
      createProgramWorkoutNutrientBurnDto,
    );
  }
  ...
  @ApiOperation({
    summary:
      "Get all program workout nutrient burns for a specific program step activity",
    operationId: "findByProgramStepActivityIdProgramWorkoutNutrientBurns",
  })
  @ApiResponse({
    status: HttpStatus.OK,
    description:
      "Return all program workout nutrient burns for the specified program step activity.",
    type: PaginatedDetailsProgramWorkoutNutrientBurnDto,
  })
  findByProgramStepActivityId(
    ...
    return this.programWorkoutNutrientBurnService.findByProgramStepActivityId(
  ...
  @ApiResponse({
    status: HttpStatus.OK,
    description:
      "The program workout nutrient burn has been successfully updated.",
    type: DetailsProgramWorkoutNutrientBurnDto,
  })
  update(
    @Param("id", ParseIntPipe) id: number,
    @Body()
    updateProgramWorkoutNutrientBurnDto: UpdateProgramWorkoutNutrientBurnDto,
  ): Promise<DetailsProgramWorkoutNutrientBurnDto> {
    return this.programWorkoutNutrientBurnService.update(
      id,
      updateProgramWorkoutNutrientBurnDto,
    );
  }
  ...
  @ApiResponse({
    ...
    description:
      "The program workout nutrient burn has been successfully deleted.",
  })
