...
export class UserConsumptionController {
  constructor(
    private readonly userConsumptionService: UserConsumptionService,
  ) {}
  ...
  async create(
    @Body() dto: CreateUserConsumptionDto,
  ...
  async getUserConsumptions(
    ...
    return await this.userConsumptionService.getUserConsumptions(
      userId,
      options,
    );
  }
