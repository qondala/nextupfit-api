...
export class UserController {
  ...
  @Get("from-manager-account/:managerAccountId")
  @ApiOperation({
    operationId: "getUserFromManagerAccountId",
    summary: "Get a user by manager account id"
  })
  @ApiParam({
  ...
  findUserWithManagerAccountId(@Param("managerAccountId", ParseIntPipe) managerAccountId: number): Promise<DetailsUserDto> {
    return this.userService.findUserWithManagerAccountId(managerAccountId);
  }
}
