...
import {
  CreateSocialAffiliateLinkDto,
  UpdateSocialAffiliateLinkDto,
} from "../dto";
...
export class SocialAffiliateLinkService {
  ...
  async create(
    createDto: CreateSocialAffiliateLinkDto,
    userId: number,
  ): Promise<SocialAffiliateLinkEntity> {
  ...
  async findAll(
    ...
    const queryBuilder = this.affiliateLinkRepository
      .createQueryBuilder("affiliateLink")
  ...
  async update(
    id: number,
    updateDto: UpdateSocialAffiliateLinkDto,
  ): Promise<SocialAffiliateLinkEntity> {
