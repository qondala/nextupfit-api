...
export class PaymentController {
  ...
  @ApiOperation({
    ...
    operationId: "getAllPaymentsReceivedByGym",
    tags: ["Gym", "Payment", "Received"],
  })
  @ApiParam({
    name: "gymId",
    required: true,
  ...
  @ApiOperation({
    summary: "Get payments received by manager paginated",
    operationId: "getAllPaymentsReceivedByManager",
    tags: ["Manager", "Payment", "Received"],
  })
  @ApiParam({
    name: "managerId",
    required: true,
  ...
  @ApiOperation({
    summary: "Get payments per cart id paginated",
    operationId: "getAllPaymentsPerCartId",
  ...
  async userPaymentPerCartId(
    @Query("userId", ParseIntPipe) userId: number,
    @Query("paymentCartId", ParseIntPipe) paymentCartId: number,
    @Query("page", ParseIntPipe) page: number = 1,
    @Query("limit", ParseIntPipe) limit: number = 10,
  ): Promise<PaginatedDetailsPaymentDto> {
